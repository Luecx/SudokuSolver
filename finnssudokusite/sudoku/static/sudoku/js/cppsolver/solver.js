        ...
        async function (moduleArg = {}) {
            ...
            (() => {
                ...
                const dispatch = ([cmd, puzzle, opt1, opt2]) => {
                    ...
                    Module.ccall(cmd, "number", ["string", "number", "number"], [puzzle, opt1, opt2])
                };
            ...
            var _solve = Module["_solve"] = wasmExports["p"];
            var _solveComplete = Module["_solveComplete"] = wasmExports["q"];
            var __emscripten_stack_restore = wasmExports["r"];
            var __emscripten_stack_alloc = wasmExports["s"];
