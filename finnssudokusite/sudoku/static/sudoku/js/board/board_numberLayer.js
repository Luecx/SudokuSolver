...
export class Cell {
    constructor(r, c) {
        ...
        this.colorMap = [
            "rgba(230,  25,  75, 0.35)", "rgba( 60, 180,  75, 0.35)", "rgba(255, 225,  25, 0.35)",
            "rgba( 67,  99, 216, 0.35)", "rgba(245, 130,  49, 0.35)", "rgba(145,  30, 180, 0.35)",
            "rgba( 70, 240, 240, 0.35)", "rgba(240,  50, 230, 0.35)", "rgba(188, 246,  12, 0.35)",
        ];
    }
