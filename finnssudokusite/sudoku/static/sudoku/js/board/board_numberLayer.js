...
export class BoardNumberLayer {
    ...
    updateCell(cell) {
        ...
        const before_string = cell.compressedString();
        cell.fromCompressedString(before_string);
        const after_string = cell.compressedString();

        if (before_string !== after_string)
            throw new Error(`Cell compressed string mismatch: ${before_string} !== ${after_string}`);
